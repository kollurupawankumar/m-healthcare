...
<div id="bodyPan">
 <div id="rightPan">
  	<div id="rightbodyPan">
	<h2><font color="red" size="5">Emergency Services</font></h2>
	<div><p>* <font size="5" color="Green"><strong>108</strong></font> Emergency response service should be called:</p>
	<p>* To save a life</p>
	<p>* To report a crime in progress</p>
	<p>* To report a fire</p>
	<p>* Anytime an emergency response is required for medical, law enforcement and fire</p>
	</div>
	</div>
</body>
</html>
